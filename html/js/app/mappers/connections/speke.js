...
define(["jquery", "app/model", "app/server", "app/connections"], function($, model, server, connections) {
    ...
    var update_connections = function() {
        ...
        return new Promise((resolve, reject) => {
            server.get(url + "/cached/mediapackage-origin-endpoint-speke-keyserver/global", api_key).then((connections) => {
    ...
    return {
        "name": "MediaPackage Origin Endpoint to SPEKE Keyserver",
        "update": update
    };
});