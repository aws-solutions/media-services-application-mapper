...
CACHED_MP_CHANNELS = [{"data": "{\"Arn\": \"arn:aws:mediapackage:us-west-2:1234567890:channels/286eb42a8bf44695a44bdb48e4fb6f3f\", \
...
CACHED_MP_ENDPOINTS = [{"data": "{\"Arn\": \"arn:aws:mediapackage:us-west-2:1234567890:origin_endpoints/9d9f3e3bf04c44efb7e0fc806a546fc3\", \
...
CACHED_MC_FLOWS = [{"data": "{\"AvailabilityZone\": \"us-east-1a\", \"EgressIp\": \"54.145.77.151\", \"Entitlements\": [], \
    ...
    \"Outputs\": [], \"Source\": {\"EntitlementArn\": \"arn:aws:mediaconnect:us-east-1:1234567890:entitlement:1-CAVaVVRQUAMLAF0P-43e6ff4eb1d4:Multiplex-2911217-pipeline-0\", \
...
CACHED_CLOUDFRONT = [{"arn": "arn:aws:cloudfront::1234567890:distribution/E2EFYSTWYTFJBN",
    "data": "{\"Id\": \"E2EFYSTWYTFJBN\", \"ARN\": \"arn:aws:cloudfront::1234567890:distribution/E2EFYSTWYTFJBN\", \
    \"Status\": \"Deployed\", \"LastModifiedTime\": \"2021-05-13 16:26:47.445000+00:00\", \"DomainName\": \"d3a4v622ogtaat.cloudfront.net\", \
    \"Aliases\": {\"Quantity\": 0}, \"Origins\": {\"Quantity\": 1, \"Items\": [{\"Id\": \"msam-upgrader-browserappmodu-msambrowserappbucket-1f8ur1bq93ntv\", \
    \"DomainName\": \"msam-upgrader-browserappmodu-msambrowserappbucket-1f8ur1bq93ntv.s3.amazonaws.com\", \"OriginPath\": \"\", \"CustomHeaders\": {\"Quantity\": 0}, \
    \"S3OriginConfig\": {\"OriginAccessIdentity\": \"origin-access-identity/cloudfront/E2E2NS1ZZJ47XM\"}, \"ConnectionAttempts\": 3, \"ConnectionTimeout\": 10, \
    \"OriginShield\": {\"Enabled\": false}}]}, \"OriginGroups\": {\"Quantity\": 0}, \"DefaultCacheBehavior\": {\"TargetOriginId\": \"msam-upgrader-browserappmodu-msambrowserappbucket-1f8ur1bq93ntv\", \
    \"TrustedSigners\": {\"Enabled\": false, \"Quantity\": 0}, \"TrustedKeyGroups\": {\"Enabled\": false, \"Quantity\": 0}, \"ViewerProtocolPolicy\": \"https-only\", \
    \"AllowedMethods\": {\"Quantity\": 3, \"Items\": [\"HEAD\", \"GET\", \"OPTIONS\"], \"CachedMethods\": {\"Quantity\": 3, \"Items\": [\"HEAD\", \"GET\", \"OPTIONS\"]}},\
     \"SmoothStreaming\": false, \"Compress\": true, \"LambdaFunctionAssociations\": {\"Quantity\": 0}, \"FunctionAssociations\": {\"Quantity\": 0}, \
     \"FieldLevelEncryptionId\": \"\", \"ForwardedValues\": {\"QueryString\": false, \"Cookies\": {\"Forward\": \"none\"}, \"Headers\": {\"Quantity\": 3, \
     \"Items\": [\"Origin\", \"Access-Control-Request-Method\", \"Access-Control-Request-Headers\"]}, \"QueryStringCacheKeys\": {\"Quantity\": 0}}, \"MinTTL\": 3600, \
     \"DefaultTTL\": 7200, \"MaxTTL\": 86400}, \"CacheBehaviors\": {\"Quantity\": 0}, \"CustomErrorResponses\": {\"Quantity\": 0}, \
     \"Comment\": \"CDN for msam-upgrader-browserappmodu-msambrowserappbucket-1f8ur1bq93ntv\", \"PriceClass\": \"PriceClass_All\", \"Enabled\": true, \
     \"ViewerCertificate\": {\"CloudFrontDefaultCertificate\": true, \"SSLSupportMethod\": \"vip\", \"MinimumProtocolVersion\": \"TLSv1\", \
     \"CertificateSource\": \"cloudfront\"}, \"Restrictions\": {\"GeoRestriction\": {\"RestrictionType\": \"none\", \"Quantity\": 0}}, \"WebACLId\": \"\", \
     \"HttpVersion\": \"HTTP1_1\", \"IsIPV6Enabled\": true, \"Tags\": {}}"
  }]
